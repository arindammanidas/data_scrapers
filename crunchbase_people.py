...
f = open('CB-People.csv','r')
g = open('CB-People-Data.csv','a+b')
cot = csv.writer(g)
line = f.readline()
count = 0
...
while line:
    ...
    try:
        row.append(str(json_data['first_name']))
    except:
        row.append(str('NA'))

    try:
        row.append(str(json_data['last_name']))
    except:
        row.append(str('NA'))
    ...
    try:
        row.append(str(json_data['affiliation_name']))
    except:
        row.append(str('NA'))

    try:
        row.append(str(json_data['birthplace']))
    except:
        row.append(str('NA'))

    try:
        row.append(str(json_data['born_year']))
    except:
        row.append(str('NA'))

    try:
        row.append(str(json_data['born_month']))
    except:
        row.append(str('NA'))

    try:
        row.append(str(json_data['born_day']))
    except:
        row.append(str('NA'))
    ...
    for i in range(0, 4):
        try:
            row.append(str(json_data['degrees'][i]['degree_type']))
        except:
            row.append(str('NA'))
            
        try:
            row.append(str(json_data['degrees'][i]['subject']))
        except:
            row.append(str('NA'))

        try:
            row.append(str(json_data['degrees'][i]['institution']))
        except:
            row.append(str('NA'))
    ...
    for i in range(0, 6):
        ...
        try:
            row.append(str(json_data['relationships'][i]['firm']['name'].encode('utf-8')))
        except:
            row.append(str('NA'))

        try:
            row.append(str(json_data['relationships'][i]['firm']['permalink'].encode('utf-8')))
        except:
            row.append(str('NA'))

        try:
            row.append(str(json_data['relationships'][i]['firm']['type_of_entity'].encode('utf-8')))
        except:
            row.append(str('NA'))
    ...
    for i in range(0, 4):
        try:
            row.append(str(json_data['web_presences'][i]['external_url']))
        except:
            row.append(str('NA'))

        try:
            row.append(str(json_data['web_presences'][i]['title']))
        except:
            row.append(str('NA'))
